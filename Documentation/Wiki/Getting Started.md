...
They follow the same principles as Simple Mode. Since this is only the Getting Started guide, I recommend you to check the according wiki pages: [MIDI Live Mode](UI/MIDI%20Live.md#readme), [Lightsaber Mode](UI/Lightsaber.md#readme).
