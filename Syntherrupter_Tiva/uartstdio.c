//
// CHANGED TO ACCEPT UART 3, 4, 5 TOO!
...
//
//*****************************************************************************
static const uint32_t g_ui32UARTBase[6] =                                   /***CHANGED***/
{
    UART0_BASE, UART1_BASE, UART2_BASE, UART3_BASE, UART4_BASE, UART5_BASE  /***CHANGED***/
};
...
//
//*****************************************************************************
static const uint32_t g_ui32UARTInt[6] =                             /***CHANGED***/
{
    INT_UART0, INT_UART1, INT_UART2, INT_UART3, INT_UART4, INT_UART5 /***CHANGED***/
};
...
//
//*****************************************************************************
static const uint32_t g_ui32UARTPeriph[6] =                         /***CHANGED***/
{
    SYSCTL_PERIPH_UART0, SYSCTL_PERIPH_UART1, SYSCTL_PERIPH_UART2,
    SYSCTL_PERIPH_UART3, SYSCTL_PERIPH_UART4, SYSCTL_PERIPH_UART5   /***CHANGED***/
};
...
UARTStdioConfig(uint32_t ui32PortNum, uint32_t ui32Baud, uint32_t ui32SrcClock)
{
    ...
    // Check the arguments.
    //
    ASSERT((ui32PortNum == 0) || (ui32PortNum == 1) ||  /***CHANGED***/
           (ui32PortNum == 2) || (ui32PortNum == 3) ||  /***CHANGED***/
           (ui32PortNum == 4) || (ui32PortNum == 5) ||  /***CHANGED***/
           );
